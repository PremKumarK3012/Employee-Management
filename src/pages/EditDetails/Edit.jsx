      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <div className="d-flex">
            <div className="formContainer">
              <input
                placeholder=""
                type="text"
                value={data.EmployeeName || ""} // Default value
                onChange={handleChange}
                name="EmployeeName"
                id="EmployeeName"
                required
            ...
            <div className="formContainer">
              <input
                placeholder=""
                type="text"
                value={data.EmployeeID || ""} // Default value
                onChange={handleChange}
                name="EmployeeID"
                id="EmployeeID"
                required
          ...
          <div className="d-flex">
            <div className="formContainer">
              <select
                value={data.Department || ""} // Default value
                onChange={handleChange}
                name="Department"
                id="Department"
                required
            ...
            <div className="formContainer">
              <select
                value={data.Designation || ""} // Default value
                onChange={handleChange}
                name="Designation"
                id="Designation"
                required
          ...
          <div className="d-flex">
            <div className="formContainer">
              <input
                placeholder=""
                type="text"
                value={data.Project || ""} // Default value
                onChange={handleChange}
                name="Project"
                required
              />
